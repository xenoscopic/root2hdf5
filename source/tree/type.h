...
namespace root2hdf5
{
    namespace tree
    {
        namespace type
        {
            ...
            // nested STL vector type into a multi-dimensional array of an HDF5
            // scalar type.  For example, this conversion would be valid for
            // types such as:
            //
            //  vector<float>
            //  vector< vector<int> >
            ...
            struct root_vector_conversion
            {
                ...
                hid_t scalar_hdf5_type; // The HDF5 scalar type equivalent to
                                        // the type at the core of the vectors
            };

            // Converts a ROOT type name representing nested STL vector types
            // into a root_vector_conversion containing metadata about the type
            // conversion.  If no conversion exists, the is_valid member of the
